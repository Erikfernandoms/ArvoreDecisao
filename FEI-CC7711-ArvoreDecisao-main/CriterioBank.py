...
def criterioBank():
    ...
    features = np.concatenate((age, average, day, duration, campaign, pdays, previous),axis=1)
    ...
    tree.plot_tree(Arvore,feature_names=['age', 'job', 'marital', 'education', 'default','average', 'housing', 'loan', 'contact', 'day', 'month', 'duration','campaign', 'pdays','previous' ],class_names=['unknown','other','failure','success'],
